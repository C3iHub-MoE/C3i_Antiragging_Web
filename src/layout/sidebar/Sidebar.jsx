...
const Sidebar = ({ collapsed }) => {
  ...
  return (
    <div
      className={`${styles.sidebar} ${styles.sidemenu} ${
    ...
    >
      ...
      <ul className={styles.navLinks}>
        <li>
          ...
          >
            <span className={styles.icon} role="img" aria-label="Dashboard">
              {" "}
              {ICONS.HOME}
            </span>
            {!collapsed && <span className={styles.linkLabel}>Dashboard</span>}
        ...
        {role === "student" && (
          <>
            ...
            >
              ...
              {!collapsed && (
                <span className={styles.linkLabel}>Register Complaint</span>
              )}
            </NavLink>
            <NavLink
              to="/my-complaints"
            ...
            >
              ...
              {!collapsed && (
                <span className={styles.linkLabel}>My Complaints</span>
              )}
            </NavLink>
          </>
        )}
          ...
          <>
            <li>
              <NavLink
                ...
                activeClassName={styles.activeLink}
              >
                <span className={styles.icon} role="img" aria-label="Students">
                  {ICONS.STUDENTS}
                </span>
                {!collapsed && (
            ...
            <li>
              <NavLink
                ...
                activeClassName={styles.activeLink}
              >
                <span className={styles.icon} role="img" aria-label="Contact">
                  {ICONS.CONTACT}
                </span>
                {!collapsed && (
