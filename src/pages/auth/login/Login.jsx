...
const Login = () => {
    ...
    const { login, loading, error } = useAuth(); // Use the login logic from context
            ...
            <div className={styles.loginBox}>
                ...
                <form onSubmit={handleLogin} className={styles.form}>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className={styles.input} placeholder="Enter your password" required />
                    </div>
