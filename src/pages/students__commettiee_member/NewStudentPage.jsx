...
const NewStudentRegister = () => {
    ...
    useEffect(() => {
        if (selectedState) {
            axios
                .get(`/api/districts?state=${selectedState}`)
            ...
            <div className={styles.registerBox}>
                ...
                <form onSubmit={handleRegister} className={styles.form}>
                    <div className={styles.inputGroup}>
                        ...
                        <input type="text" value={username} onChange={handleUsernameChange} placeholder="Enter your username" required className={styles.input} />
                        {usernameError && <span className={styles.error}>{usernameError}</span>}
                    </div>

                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Email</label>
                        <input type="email" value={email} onChange={handleEmailChange} className={styles.input} placeholder="Enter your email" required />
                        {emailError && <span className={styles.error}>{emailError}</span>}
                    </div>

                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Phone Number</label>
                        <input type="text" value={phoneNumber} onChange={handlePhoneChange} className={styles.input} placeholder="Enter your phone number" required />
                        {phoneError && <span className={styles.error}>{phoneError}</span>}
                    </div>

                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Password</label>
                        <input type="password" value={password} onChange={handlePasswordChange} className={styles.input} placeholder="Enter your password" required />
                        {passwordError && <span className={styles.error}>{passwordError}</span>}
                    </div>

                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Confirm Password</label>
                        <input type="password" value={confirmPassword} onChange={handleConfirmPasswordChange} className={styles.input} placeholder="Confirm your password" required />
                        {confirmPasswordError && <span className={styles.error}>{confirmPasswordError}</span>}
                    </div>

                    <div className={styles.inputGroup}>
                        <label className={styles.label}>Age</label>
                        <input type="number" value={age} onChange={(e) => setAge(e.target.value)} className={styles.input} placeholder="Enter your age" required />
                    </div>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <select value={selectedState} onChange={handleStateChange} className={styles.input} required>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <select value={district} onChange={(e) => setDistrict(e.target.value)} className={styles.input} required disabled={!selectedState}>
                            <option value="" disabled>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <select value={collegeName} onChange={(e) => setCollegeName(e.target.value)} className={styles.input} required>
                            <option value="" disabled>
                                Select your college
                            </option>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input type="file" onChange={handleFileChange} className={styles.input} accept=".pdf,.jpg,.jpeg,.png" required />
                    </div>
