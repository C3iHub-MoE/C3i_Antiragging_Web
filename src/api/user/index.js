...
export const sosHistory = async (role, userId, payload, signal) => {
  const url = `${Constants.API_URLS.SOS_HISTORY}?role=${role}&user_id=${userId}`;
  const response = await apiClient.get(url, payload, { signal });
  return response.data?.data;
};
...
export const studentList = async (college, payload, signal) => {
  ...
  const url = `${Constants.API_URLS.STUDENTS_LIST}/students/`;
  const response = await apiClient.get(url, payload, { signal });
  return response.data?.data;
};
export const memberList = async (college, payload, signal) => {
  const url = `${Constants.API_URLS.MEMBER_LIST}/members/`;
  const response = await apiClient.get(url, payload, { signal });
  return response.data?.data;
};
export const currentUserList = async (payload, signal) => {
  const url = `${Constants.API_URLS.USER_PROFILE_LIST}`;
  const response = await apiClient.get(url, payload, { signal });
  return response.data?.data;
};
...
export const resendOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.USER_RESEND_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
...
export const sendOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.USER_SEND_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
...
export const verifyOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.USER_VERIFY_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
...
export const AccountResendOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.ACCOUNT_RESEND_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
...
export const AccountSendOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.ACCOUNT_SEND_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
...
export const AccountVerifyOtp = async (payload, signal) => {
  const response = await apiClient.post(
    Constants.API_URLS.ACCOUNT_VERIFY_OTP,
    payload,
    { signal }
  );
  return response.data?.data;
